...
async function submitManualQuiz() {
    ...
    const result = await apiRequest('/api/mentor/create-quiz', 'POST', {
        ...
        allow_skip: document.getElementById('allow-skip')?.checked || false,
        allow_jump: document.getElementById('allow-jump')?.checked || false,
        nav_lock_seconds: document.getElementById('enable-nav-lock')?.checked ? parseInt(document.getElementById('nav-lock-seconds')?.value || '7') : 0,
    });
...
async function generateAIQuiz() {
    ...
    const result = await apiRequest('/api/mentor/ai-generate-quiz', 'POST', {
        ...
        allow_skip: document.getElementById('ai-allow-skip')?.checked || false,
        allow_jump: document.getElementById('ai-allow-jump')?.checked || false,
        nav_lock_seconds: document.getElementById('ai-enable-nav-lock')?.checked ? parseInt(document.getElementById('ai-nav-lock-seconds')?.value || '7') : 0,
    });
