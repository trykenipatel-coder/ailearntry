...
async function submitManualQuiz() {
    ...
    if (result.success) {
        showAlert('Quiz saved as draft! Go to AI Quiz page to publish it.', 'success');
        setTimeout(() => { if (confirm('Publish this quiz now?')) { window.location.href = `ai-quiz.html`; } }, 500);
