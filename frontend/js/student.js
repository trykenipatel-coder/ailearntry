...
async function validateAndStart() {
    ...
    if (result.success) {
        ...
        // Always reload quiz data after code validation
        try {
            ...
            console.error('Failed to reload quiz data:', e);
        }
    } else {
        if (errorEl) {
...
async function startQuiz() {
    ...
    if (typeof initProctoring === "function" && quizState.quizId) {
        initProctoring(parseInt(quizState.quizId));
    }
